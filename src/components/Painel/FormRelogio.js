...
function FormRelogio() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (uploadTask) {
      ...
      try {
        await addDoc(collection(db, "Relogios"), {
          Modelo: modelo,
          Descricao: descricao,
          Preco: Number(preco),
          ImagemUrl: imageUrl,
        });
        alert("Relógio adicionado com sucesso!");
        ...
        console.error("Erro ao adicionar relógio: ", error);
        alert("Erro ao adicionar relógio!");
      }
    }
  };
